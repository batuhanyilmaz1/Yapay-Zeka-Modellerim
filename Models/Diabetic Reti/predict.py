"""
Diyabetik Retinopati Tespit Modeli (Tahmin Betiği)

Eğitilmiş MobileNetV2-VGG16-DiabeticReti.h5 modelini yükler ve TEST
klasöründeki görüntüler üzerinde tahmin yapıp sonucu görselleştirir.
"""
...
MODEL_PATH = os.path.join(os.path.dirname(__file__), "MobileNetV2-VGG16-DiabeticReti.h5")
...
def predict_single(model, img_path: str):
    """Tek bir görüntü için sınıf ve güven skorunu döndürür.

    Model tek nöronlu sigmoid çıktısı üretir; 2 nöronlu softmax çıktısı
    verecek şekilde yeniden eğitilirse de doğru şekilde ele alınır.
    """
